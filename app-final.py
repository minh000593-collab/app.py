...
st.info("⚠️ Kết quả chỉ mang tính tham khảo, có thể sai lệch tùy theo chất lượng âm thanh, môi trường ghi âm và cách nói. AI chỉ là công cụ hỗ trợ, không thể thay thế đánh giá của con người.")
